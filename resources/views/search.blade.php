            ...
            <form name="filter_selections" id="filter_selections">
                ...
                <ul class="c_ul_1" style="background:#39B54A;margin-bottom: 0px">
                    ...
                    <li style="padding: 5px;background:#39B54A;height: 54px">
                        ...
                        <div id="c_filter_no_select_wrn" style="display: none;position: relative; margin-top: -137px;">
                            <div style="border-radius: 5px;padding: 4px;width: 240px; height: 70px; background: #CE2316; margin-left: 10px;">
                                <div style="border-radius: 5px;background: #FBFF00;width: 100%;height: 100%;text-align: center;padding-top: 17px">
                                    <span style="font-size: 20px;">Please Select any Field</span>
                                </div>
                            </div>
                            <div id="arrow_down" style="border-top:20px solid #CE2316;margin-left: 110px"></div>
                        </div>
                    </li>
