<div style="font-family: 'Segoe UI', 'Roboto', 'Helvetica Neue'">
    ...
    <div><span style="color: #339a44;font-size: 24px">Forgot your password ?</span></div>
    <div style="margin-top: 10px">You can reset your password by providing below access code in the reset screen.</div>
    <br/>
    <div style="font-size: 20px;">Access Code : <span style="color:#2b669a">{{ $access_code }}</span></div>
    <br/>
