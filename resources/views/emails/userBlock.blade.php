<div style="font-family: 'Segoe UI', 'Roboto', 'Helvetica Neue'">
    ...
    <div><span style="color: #339a44;font-size: 24px">{{ $first_name }}&nbsp;{{ $last_name }}  Your account has been deactivated </span></div>
    <div style="margin-top: 10px">Your account has been deactivated due to inappropriate behaviour.</div>
    <br/>
