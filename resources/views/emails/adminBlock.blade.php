<div style="font-family: 'Segoe UI', 'Roboto', 'Helvetica Neue'">
    ...
    <div><span style="color: #339a44;font-size: 24px">{{ $first_name }}&nbsp;{{ $last_name }}  Your account has been diactivated </span></div>
    <div style="margin-top: 10px">Your admin account of<span style="color: #339a44;font-size: 14px"> eAyurveda.lk</span> has been deavtivated. </div>
    <br/>
