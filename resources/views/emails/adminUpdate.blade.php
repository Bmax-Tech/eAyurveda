<div style="font-family: 'Segoe UI', 'Roboto', 'Helvetica Neue'">
    ...
    <div><span style="color: #339a44;font-size: 24px">Your Login Details Changed.</span>
    <div style="margin-top: 10px">{{ $first_name }}&nbsp;{{ $last_name }} . &nbsp;&nbsp; Your eAyurveda.lk login details are changed. </div>
    <br/>
    <div>Your eAyurveda user name is : <span style="color:#2b669a">{{ $username }}</span></div>
    <div>Your eAyurveda password  is : <span style="color:#2b669a">{{ $password }}</span></div>
    <br/>
